...
> ⚠️ **A newer version is available.** This project has moved to [**RickMcConney/kam**](https://github.com/RickMcConney/freazyKam2). Please use the new repository for the latest features and updates — **[Launch the new version](https://rickmcconney.github.io/freazyKam2/)**.
